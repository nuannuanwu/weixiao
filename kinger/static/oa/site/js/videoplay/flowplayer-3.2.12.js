...
function() {
    ...
    function o(t) {
        ...
        if (r != -1) {
            ...
            var s = [];
            n(document.getElementsByTagName(q),
            function() {
    ...
    var i = function(u, s, t) {
        ...
        j(this, u, true);
        n(("Begin*,Start,Pause*,Resume*,Seek*,Stop*,Finish*,LastSecond,Update,BufferFull,BufferEmpty,BufferStop").split(","),
        function() {
            var w = "on" + this;
            if (w.indexOf("*") != -1) {
            ...
            if (n.expressInstall && g.isSupported([6, 65])) {
                ...
                if (!f.innerHTML.replace(/\s/g, "")) {
                  /*f.innerHTML = "<h2>Flash version "+n.version+" or greater is required</h2><h3>"+(k[0]>0?"Your version is "+k:"You have no flash plugin installed")+"</h3>"+(f.tagName=="A"?"<p>Click here to download latest version</p>":"<p>Download latest version from <a href='"+j+"'>here</a></p>"*/
                    f.innerHTML = "<h2 style='line-height:40px;'>你没有开启Flash,或者Flash版本小于 </br>" + n.version + "</h2><h3>" + (k[0] > 0 ? "你的Flash版本是 " + k: "你没有安装flash插件") + "</h3>" + (f.tagName == "A" ? "<p>点击这里下载最新版本</p>": "<p>下载最新版本<a href='" + j + "'>点击下载</a></p>");

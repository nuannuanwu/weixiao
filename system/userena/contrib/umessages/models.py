...
class MessageRecipient(models.Model):
    ...
    is_push = models.BooleanField(_("is push"),default=0)
    no_need_send = models.BooleanField(_("no need send"),default=0)
    is_send = models.BooleanField(_("is send"),default=0)
    ...
    def update_contacts(self, to_user_list):
        ...
        for user in to_user_list:
            MessageContact.objects.update_contact(self.sender,
                                                  user,
                                                  self)
            MessageContact.objects.update_contact(user,
                                                  self.sender,
                                                  self)
            updated = True
        return updated

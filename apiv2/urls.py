...
urlpatterns = patterns('apiv2.views',
    ...
    url(r'^tiles/like/$', "tiles_likeable", {"method": "post"}, name="api_tiles_like_rev"),
    
    # 给 web 端使用的特殊接口. 对提交进行 ``csrf`` 保护(防止跨域提交).
    url(r'^web/tiles/like/$', "web_tiles_likeable", {"method": "post"}, name="api_web_tiles_like_rev"),
    ...
    url(r'^web/comments/create/$', "web_comments", {"method": "post"}, name="api_web_comments_create_rev"),
